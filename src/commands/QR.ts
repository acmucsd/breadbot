...
export default class QR extends Command {
  ...
  public async run(interaction: CommandInteraction): Promise<void> {
    ...
    const content = interaction.options.get('content', true);
    const titleArgument = interaction.options.get('title');
    ...
    //
    const qrCode = QR.generateQR(String(content), String(titleArgument) || '', '');
